...
const Certificate = () => {
  return (
    <article className="h-5/6 w-full max-sm:p-5">
      ...
      <CertCards title="KodeGo Cert" desc="Full Stack Web Dev" year="2023" href='https://robertramos07281021.github.io/robert-my-portfolio/assets/KodeGo-CERT-CFJMrXqA.PNG' src={getImageUrl('KodeGo-CERT.PNG')}/>
      </div>
    </article>
  )
}
