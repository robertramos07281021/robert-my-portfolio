...
import navCloseBtn from '../assets/closebutton.png'
import menuBtn from '../assets/menubutton.png'
...
const Header = () => {
  ...
  return (
    <nav className=" h-20 flex justify-between items-center max-sm:px-6 md:px-8 lg:px-10 xl:px-10 2xl:px-10 bg-black text-lime-400  shadow-lg shadow-lime-500 fixed w-screen z-50"> 
      ...
      <img src={toggleMenu ? {navCloseBtn} : {menuBtn}} alt="menubutton" className="w-10 h-10 block md:hidden lg:hidden xl:hidden 2xl:hidden" onClick={showMenu}/>
