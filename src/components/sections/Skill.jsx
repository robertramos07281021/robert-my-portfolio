  ...
  return (
    <article className=" h-5/6 w-full max-sm:p-5">
      ...
      <div className="h-5/6 w-full bg-white/10 flex flex-col gap-2 rounded p-2 overflow-y-auto overflow-hidden">
        ...
        <SkillsModal label='MongoDB' text="I can create database using MongoDB, I can manipulate the data, how to populate, how to create a relationship between database models. I can handle aggregataions in order to count the numbers of each rows it depends on query. "/>
        <SkillsModal label='MySQL' text="I can create database using MySQL, I can manipulate the data, how to create a rational between database schemas.  I can handle aggregataions in order to count the numbers of each rows it depends on query "/>
